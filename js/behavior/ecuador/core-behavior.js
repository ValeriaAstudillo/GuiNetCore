...
ConstantsBehaivor.PLACEHOLDER_PHONE = "9 dígitos";
//Formato del número celular
ConstantsBehaivor.PLACEHOLDER_CELLPHONE = "10 dígitos";
//Formato de la identificación Natural
ConstantsBehaivor.PLACEHOLDER_DNI = "10 dígitos ";
//Formato de la identificacion Jurídica
ConstantsBehaivor.PLACEHOLDER_RUC = "13 dígitos ";

ConstantsBehaivor.PLACEHOLDER_PASSPORT = "16 dígitos ";
...
ConstantsBehaivor.PATTERN_CED = '^([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9])+$';
ConstantsBehaivor.PATTERN_RUC = '^([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9])+$';
